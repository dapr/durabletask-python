...
class AsyncWorkflowContext(DeterministicContextMixin):
    ...
    def sub_orchestrator(
        ...
        *,
        ...
        """
        self._log_operation("sub_orchestrator", {
            "function": str(workflow_fn),
            "input": input,
    ...
    def gather(self, *awaitables: AwaitableBase[Any], return_exceptions: bool = False) -> WhenAllAwaitable[Any]:
        """
