...
async def problematic_workflow_best_effort(ctx, input_data):
    ...
    # Run an activity
    result = await ctx.activity('simple_activity', input='Hello from problematic workflow')
...
def main():
    ...
    with TaskHubGrpcWorker() as worker:
        ...
        instance_id_3 = client.schedule_new_orchestration('good_workflow', input={'test': 'good'})
