...
class TestCICompatibility:
    ...
    def test_enhanced_methods_are_additive_only(self):
        ...
        extra_methods = [item.split(': ')[1] for item in report['extra_members'] if 'method:' in item]
    ...
    def test_protocol_compliance_at_class_level(self):
        ...
        assert is_compliant, "AsyncWorkflowContext does not comply with OrchestrationContextProtocol"
