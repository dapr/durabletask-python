...
class TestAsyncWorkflowContext:
    ...
    def setup_method(self):
        ...
        self.mock_base_ctx.trace_parent = "test-trace-parent"
        self.mock_base_ctx.trace_state = "test-trace-state"
        self.mock_base_ctx.orchestration_span_id = "test-span-id"
    ...
    def test_trace_properties(self):
        """Test trace-related properties."""
        assert self.ctx.trace_parent == "test-trace-parent"
        assert self.ctx.trace_state == "test-trace-state"
        assert self.ctx.workflow_span_id == "test-span-id"
    ...
    def test_continue_as_new_method(self):
        ...
        self.mock_base_ctx.continue_as_new.assert_called_once_with(
            new_input, 
            save_events=True
        )
